...
export default function AzureServicesSection() {
  ...
  function openCalendly(e) {
    ...
    // Use Calendly inline popup if script is ready
    if (window.Calendly && typeof window.Calendly.initPopupWidget === "function") {
      window.Calendly.initPopupWidget({ url: CALENDLY_URL });
    } else {
      // fallback: show our own centered iframe
  ...
  return (
    ...
    >
      ...
      {/* Custom centered Calendly iframe */}
      {showCalendly && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
          <div className="relative w-full max-w-2xl h-[80vh] bg-black rounded-2xl overflow-hidden ring-1 ring-yellow-500/30">
            <iframe
              src="https://calendly.com/aitheron/new-meeting?background_color=000000&text_color=ffffff&primary_color=d4a017"
              title="Calendly"
